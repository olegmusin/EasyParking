        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedBy = table.Column<string>(nullable: true),
                    CreatedDate = table.Column<DateTime>(nullable: false),
                    IsParkingAllowed = table.Column<bool>(nullable: false),
                    ModifiedBy = table.Column<string>(nullable: true),
                    ModifiedDate = table.Column<DateTime>(nullable: true),
                    Name = table.Column<string>(nullable: true),
                    Occupied = table.Column<bool>(nullable: false),
                    ParkingId = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ParkingSessions_Parkings_ParkingId",
                        column: x => x.ParkingId,
                        principalTable: "Parkings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ParkingSessions_Places_PlaceId",
                        column: x => x.PlaceId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParkingSessions_ParkingId",
                table: "ParkingSessions",
                column: "ParkingId");

            migrationBuilder.CreateIndex(
                name: "IX_ParkingSessions_PlaceId",
                table: "ParkingSessions",
                column: "PlaceId");
